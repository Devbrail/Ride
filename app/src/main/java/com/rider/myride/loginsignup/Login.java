...
import com.rider.myride.countrypicker.Utils;
                ...
                try {
                    ...
                    if (countryselected) {
                        if (name.isEmpty() && pass.isEmpty()) {
                            ...
                            Log.d(TAG, "login json: " + logindetails.toString());
...
//            setCountrylabel("ke");
            ...
            countrySelectLayout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(Login.this, "selct ", Toast.LENGTH_SHORT).show();
                    slectcountry();
                }
            });
    ...
    void slectcountry() {
        CountryPickerDialog = new CountryPickerDialog(Login.this, new CountryPickerCallbacks() {
            ...
            public void onCountrySelected(Country country, int flagResId) {
                Log.d(TAG, "onCountrySelected: " + country.toString());
    ...
    public void selectcontry(View view) {
